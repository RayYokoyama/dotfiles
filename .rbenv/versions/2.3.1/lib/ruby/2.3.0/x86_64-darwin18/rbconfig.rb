...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.3.0/x86_64-darwin18")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/ray_yokoyama/.rbenv/versions/2.3.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/ray_yokoyama/.rbenv/versions/2.3.1' '--with-openssl-dir=/usr/local/opt/openssl' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/ray_yokoyama/.rbenv/versions/2.3.1/lib ' 'CPPFLAGS=-I/Users/ray_yokoyama/.rbenv/versions/2.3.1/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/ray_yokoyama/.rbenv/versions/2.3.1"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/ray_yokoyama/.rbenv/versions/2.3.1/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/ray_yokoyama/.rbenv/versions/2.3.1/lib  -fstack-protector -L/usr/local/lib"
