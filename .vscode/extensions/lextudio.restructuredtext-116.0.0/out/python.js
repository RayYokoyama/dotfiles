    ...
    async setup(resource) {
        ...
        if (path) {
            ...
            if (configuration_1.Configuration.getConfPath(resource) === '') {
                if (!configuration_1.Configuration.getDocUtilDisabled() && !(await this.checkDocutilsInstall())) {
                ...
                if (!configuration_1.Configuration.getSphinxDisabled() && !(await this.checkSphinxInstall() || (sphinx != null && await common_1.fileExists(sphinx)))) {
            ...
            if (!configuration_1.Configuration.getLinterDisabled() && !(await this.checkDoc8Install() || (doc8 != null && await common_1.fileExists(doc8)))) {
